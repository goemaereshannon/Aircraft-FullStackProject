    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AirplaneClasses", x => new { x.AirplaneId, x.ClassId });
                    table.ForeignKey(
                        name: "FK_AirplaneClasses_Airplanes_AirplaneId",
                        column: x => x.AirplaneId,
                        principalTable: "Airplanes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AirplaneClasses_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationPrices", x => new { x.ReservationId, x.PriceId });
                    table.ForeignKey(
                        name: "FK_ReservationPrices_Prices_PriceId",
                        column: x => x.PriceId,
                        principalTable: "Prices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ReservationPrices_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationSeat_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AirplaneClasses_ClassId",
                table: "AirplaneClasses",
                column: "ClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationPrices_PriceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationSeat_PersonId",
