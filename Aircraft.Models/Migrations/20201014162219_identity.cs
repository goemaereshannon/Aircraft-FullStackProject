    ...
    public partial class identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Companions", x => x.PersonId);
                    table.ForeignKey(
                        name: "FK_Companions_Adresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Adresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AirplaneClass", x => new { x.AirplaneId, x.ClassId });
                    table.ForeignKey(
                        name: "FK_AirplaneClass_Airplanes_AirplaneId",
                        column: x => x.AirplaneId,
                        principalTable: "Airplanes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AirplaneClass_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<Guid>(nullable: false),
                    RoleId = table.Column<Guid>(nullable: false),
                    RegisteredUserId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserRoles", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_RegisteredUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationPrice", x => new { x.ReservationId, x.PriceId });
                    table.ForeignKey(
                        name: "FK_ReservationPrice_Prices_PriceId",
                        column: x => x.PriceId,
                        principalTable: "Prices",
                        principalColumn: "Id"
                       );
                    table.ForeignKey(
                        name: "FK_ReservationPrice_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationSeat_Companions_CompanionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_RegisteredUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationPrice_PriceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationSeat_CompanionId",
