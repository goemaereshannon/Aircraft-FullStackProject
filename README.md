...
Furthermore, apart from some basic features, this framework was completely new to both of us. So before we started we dived into transforming our **XD design** into code, we followed some courses on Pluralsight.
